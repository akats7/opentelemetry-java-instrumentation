...
public abstract class AbstractDynamoDbClientTest extends AbstractBaseAwsClientTest {
  ...
  public void sendRequestWithMockedResponse() throws Exception {
    ...
    assertRequestWithMockedResponse(
        ...
        //ImmutableMap.of("aws.table.name", Pair.of(AttributeType.STRING,"sometable"), "db.system", Pair.of(AttributeType.STRING,"dynamodb"),"aws.dynamodb.table_names", Pair.of(AttributeType.STRING_ARRAY, tableList)));
  }
}
